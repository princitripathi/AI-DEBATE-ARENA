...
- **Debater agents** (`gpt-4o-mini`) are each given a persona and expertise (e.g. "technology economist," "labor economist") to keep arguments grounded and distinct.
- **Judge agent** (`gpt-4o`, temperature `0`) evaluates the full transcript and returns a structured verdict: winner, scores, strongest argument per side, and a balanced synthesis.
...
- **Framework**: LangChain
- **Models**: GPT-4o-mini (debaters) + GPT-4o (judge)
- **Language**: Python
